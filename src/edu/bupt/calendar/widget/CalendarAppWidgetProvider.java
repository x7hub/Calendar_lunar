...
public class CalendarAppWidgetProvider extends AppWidgetProvider {
    ...
    static final String EXTRA_EVENT_IDS = "edu.bupt.calendar.EXTRA_EVENT_IDS";
    ...
    private void performUpdate(Context context,
        ...
        for (int appWidgetId : appWidgetIds) {
            ...
            launchCalendarIntent
                    .setData(Uri.parse("content://edu.bupt.calendar/time/" + millis));
    ...
    static Intent getLaunchFillInIntent(Context context, long id, long start, long end,
        ...
        String dataString = "content://edu.bupt.calendar/events";
        if (id != 0) {
